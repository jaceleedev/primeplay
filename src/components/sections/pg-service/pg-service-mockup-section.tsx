      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col items-center justify-center gap-y-8 sm:gap-y-10 md:gap-y-12 mb-16 sm:mb-20 md:mb-24">
          ...
          <div className="flex items-center gap-x-4 md:gap-x-6">
            <Image
              src="/logos/sk-play-logo.svg"
              alt="SK Play Logo"
              width={80}
              height={80}
              className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24"
            />
            <h2 className="font-bold text-5xl sm:text-6xl md:text-7xl text-[#37AFE4]">
              SK-PLAY
            </h2>
          </div>
          ...
          <div className="flex items-center gap-x-4 md:gap-x-6">
            <Image
              src="/logos/ty-play-logo.svg"
              alt="TY Play Logo"
              width={80}
              height={80}
              className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24"
            />
            <h2 className="font-bold text-5xl sm:text-6xl md:text-7xl text-[#FFDC73]">
              TY-PLAY
            </h2>
          </div>
        </div>
          ...
          <div className="relative w-full pt-[52.87%] sm:left-[-1%]">
            ...
            <div className="absolute z-20 w-[80%] h-[86%] top-[6%] left-1/2 -translate-x-1/2">
              <div className="relative w-full h-full overflow-hidden">
                <Image
                  src="/images/ty-macbook-screen.webp"
                  alt="PG Service on Macbook"
                  fill
            ...
            <div className="absolute z-30 w-[18%] h-[68%] -bottom-[10%] right-0 sm:right-[-2%]">
              ...
              >
                <div className="relative w-full h-full">
                  <Image
                    src="/images/ty-iphone-screen.webp"
                    alt="PG Service on iPhone"
                    fill
...
export default PgServiceMockupSection;
