...
export const productCards: ProductCardProps[] = [
  {
    ...
    // 기본 색상 사용 (#C60000, #FF6D00)
  },
  {
    icon: <ViralMarketingIcon />,
    title: "바이럴 마케팅",
    description:
      "실사용 경험을 토대로 한 정보 공유로 높은 신뢰성을 구축합니다.",
    gradientColors: { from: "#3300ED", to: "#00FF62" },
  },
  {
    icon: <WebAppDevelopmentIcon />,
    title: "Web/App 개발",
    description: "최신 기술과 노하우를 바탕으로 고품질의 서비스를 제공합니다.",
  ...
  },
  {
    ...
    title: "CSI PLAY",
    description:
      "투자자들이 주식, 코인 정보를 공유하고 소통하는 커뮤니티 사이트",
    gradientColors: { from: "#3300ED", to: "#00FF62" },
  },
  {
    icon: <TYPlayIcon />,
    title: "TY PLAY",
    description:
      "사업자는 물론, 개인도 사용 가능한 결제 단말기와 PG 서비스를 제공합니다.",
    gradientColors: { from: "#6C00AA", to: "#FF2684" },
  },
];
